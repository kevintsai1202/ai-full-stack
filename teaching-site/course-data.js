...
window.COURSE = {
  ...
  "subtitle": "結合 Spring Boot 3.5 與 React 19，從後端分層、向量資料庫到前端 AI 助理，完成具備 RAG 長期記憶與 MCP 工具鏈的企業級 CRM 系統。",
  "meta": {
    "program": "AI 全端開發系列課程",
    "title": "AI 賦能全端開發：從零打造企業級智慧應用",
    "subtitle": "結合 Spring Boot 3.5 與 React 19，從後端分層、向量資料庫到前端 AI 助理，完成具備 RAG 長期記憶與 MCP 工具鏈的企業級 CRM 系統。",
    ...
    "techStack": [
      ...
      [
        "AI 整合框架",
        "Spring AI 1.1.x / OpenAI ChatClient"
      ],
      [
        "前端技術棧",
